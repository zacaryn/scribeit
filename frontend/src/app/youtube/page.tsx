...
export default function YouTubePage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      // Make a real API call to the YouTube processing endpoint
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/youtube/process`, {
        method: 'POST',
        headers: {
      ...
      // Redirect to the summary page with the actual summary ID
      router.push(`/summary/${data.summary_id}`);
